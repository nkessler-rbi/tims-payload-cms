...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_pages_blocks_hero_banner_links_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE "public"."enum_pages_blocks_hero_banner_links_link_appearance" AS ENUM('default', 'outline');
  CREATE TYPE "public"."enum_pages_blocks_hero_banner_alignment" AS ENUM('left', 'center');
  CREATE TYPE "public"."enum_pages_blocks_text_with_image_media_position" AS ENUM('right', 'left');
  CREATE TYPE "public"."enum_pages_blocks_text_with_image_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE "public"."enum_pages_blocks_text_with_image_link_appearance" AS ENUM('default', 'outline');
  CREATE TYPE "public"."enum_pages_blocks_double_image_card1_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE "public"."enum_pages_blocks_double_image_card2_link_type" AS ENUM('reference', 'custom');
  ...
  CREATE TYPE "public"."enum__pages_v_blocks_hero_banner_links_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE "public"."enum__pages_v_blocks_hero_banner_links_link_appearance" AS ENUM('default', 'outline');
  CREATE TYPE "public"."enum__pages_v_blocks_hero_banner_alignment" AS ENUM('left', 'center');
  CREATE TYPE "public"."enum__pages_v_blocks_text_with_image_media_position" AS ENUM('right', 'left');
  CREATE TYPE "public"."enum__pages_v_blocks_text_with_image_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE "public"."enum__pages_v_blocks_text_with_image_link_appearance" AS ENUM('default', 'outline');
  CREATE TYPE "public"."enum__pages_v_blocks_double_image_card1_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE "public"."enum__pages_v_blocks_double_image_card2_link_type" AS ENUM('reference', 'custom');
  ...
  CREATE TABLE "pages_blocks_hero_banner_links" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"link_type" "enum_pages_blocks_hero_banner_links_link_type" DEFAULT 'reference',
  	"link_new_tab" boolean,
  	"link_url" varchar,
  	"link_label" varchar,
  	"link_appearance" "enum_pages_blocks_hero_banner_links_link_appearance" DEFAULT 'default'
  );
  ...
  CREATE TABLE "pages_blocks_hero_banner" (
  	...
  	"title" varchar,
  	"subtitle" varchar,
  	"alignment" "enum_pages_blocks_hero_banner_alignment" DEFAULT 'left',
  	"anchor_id" varchar,
  	"block_name" varchar
  );
  ...
  CREATE TABLE "pages_blocks_anchor_links_items" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"label" varchar,
  	"target_anchor_id" varchar
  );
  
  CREATE TABLE "pages_blocks_anchor_links" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"_locale" "_locales" NOT NULL,
  ...
  CREATE TABLE "pages_blocks_text_with_image" (
  	...
  	"_locale" "_locales" NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"media_position" "enum_pages_blocks_text_with_image_media_position" DEFAULT 'right',
  	"rich_text" jsonb,
  	"media_id" integer,
  	"enable_cta" boolean,
  	"link_type" "enum_pages_blocks_text_with_image_link_type" DEFAULT 'reference',
  	"link_new_tab" boolean,
  	"link_url" varchar,
  	"link_label" varchar,
  	"link_appearance" "enum_pages_blocks_text_with_image_link_appearance" DEFAULT 'default',
  	"anchor_id" varchar,
  	"block_name" varchar
  );
  ...
  CREATE TABLE "pages_blocks_double_image" (
  	...
  	"_locale" "_locales" NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"card1_image_id" integer,
  	"card1_heading" varchar,
  	"card1_body" varchar,
  	"card1_enable_cta" boolean,
  	"card1_link_type" "enum_pages_blocks_double_image_card1_link_type" DEFAULT 'reference',
  	"card1_link_new_tab" boolean,
  	"card1_link_url" varchar,
  	"card1_link_label" varchar,
  	"card2_image_id" integer,
  	"card2_heading" varchar,
  	"card2_body" varchar,
  	"card2_enable_cta" boolean,
  	"card2_link_type" "enum_pages_blocks_double_image_card2_link_type" DEFAULT 'reference',
  	"card2_link_new_tab" boolean,
  	"card2_link_url" varchar,
  	"card2_link_label" varchar,
  	"anchor_id" varchar,
  	"block_name" varchar
  );
  ...
  CREATE TABLE "_pages_v_blocks_hero_banner_links" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"link_type" "enum__pages_v_blocks_hero_banner_links_link_type" DEFAULT 'reference',
  	"link_new_tab" boolean,
  	"link_url" varchar,
  	"link_label" varchar,
  	"link_appearance" "enum__pages_v_blocks_hero_banner_links_link_appearance" DEFAULT 'default',
  	"_uuid" varchar
  );
  ...
  CREATE TABLE "_pages_v_blocks_hero_banner" (
  	...
  	"title" varchar,
  	"subtitle" varchar,
  	"alignment" "enum__pages_v_blocks_hero_banner_alignment" DEFAULT 'left',
  	"anchor_id" varchar,
  	"_uuid" varchar,
  	"block_name" varchar
  );
  ...
  CREATE TABLE "_pages_v_blocks_anchor_links_items" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "_pages_v_blocks_anchor_links" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"_locale" "_locales" NOT NULL,
  ...
  CREATE TABLE "_pages_v_blocks_text_with_image" (
  	...
  	"_locale" "_locales" NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"media_position" "enum__pages_v_blocks_text_with_image_media_position" DEFAULT 'right',
  	"rich_text" jsonb,
  	"media_id" integer,
  	"enable_cta" boolean,
  	"link_type" "enum__pages_v_blocks_text_with_image_link_type" DEFAULT 'reference',
  	"link_new_tab" boolean,
  	"link_url" varchar,
  	"link_label" varchar,
  	"link_appearance" "enum__pages_v_blocks_text_with_image_link_appearance" DEFAULT 'default',
  	"anchor_id" varchar,
  	"_uuid" varchar,
  	"block_name" varchar
  );
  ...
  CREATE TABLE "_pages_v_blocks_double_image" (
  	...
  	"card1_body" varchar,
  	"card1_enable_cta" boolean,
  	"card1_link_type" "enum__pages_v_blocks_double_image_card1_link_type" DEFAULT 'reference',
  	"card1_link_new_tab" boolean,
  	"card1_link_url" varchar,
  	"card1_link_label" varchar,
  	"card2_image_id" integer,
  	...
  	"card2_body" varchar,
  	"card2_enable_cta" boolean,
  	"card2_link_type" "enum__pages_v_blocks_double_image_card2_link_type" DEFAULT 'reference',
  	"card2_link_new_tab" boolean,
  	"card2_link_url" varchar,
  	"card2_link_label" varchar,
  	"anchor_id" varchar,
  ...
  ALTER TABLE "pages_blocks_hero_banner_links" ADD CONSTRAINT "pages_blocks_hero_banner_links_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages_blocks_hero_banner"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "pages_blocks_anchor_links_items" ADD CONSTRAINT "pages_blocks_anchor_links_items_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages_blocks_anchor_links"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "pages_blocks_anchor_links" ADD CONSTRAINT "pages_blocks_anchor_links_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "pages_blocks_double_image" ADD CONSTRAINT "pages_blocks_double_image_card1_image_id_media_id_fk" FOREIGN KEY ("card1_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "pages_blocks_double_image" ADD CONSTRAINT "pages_blocks_double_image_card2_image_id_media_id_fk" FOREIGN KEY ("card2_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "_pages_v_blocks_hero_banner_links" ADD CONSTRAINT "_pages_v_blocks_hero_banner_links_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v_blocks_hero_banner"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_pages_v_blocks_anchor_links_items" ADD CONSTRAINT "_pages_v_blocks_anchor_links_items_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v_blocks_anchor_links"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_pages_v_blocks_anchor_links" ADD CONSTRAINT "_pages_v_blocks_anchor_links_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_pages_v_blocks_double_image" ADD CONSTRAINT "_pages_v_blocks_double_image_card1_image_id_media_id_fk" FOREIGN KEY ("card1_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "_pages_v_blocks_double_image" ADD CONSTRAINT "_pages_v_blocks_double_image_card2_image_id_media_id_fk" FOREIGN KEY ("card2_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "pages_blocks_hero_banner_links_order_idx" ON "pages_blocks_hero_banner_links" USING btree ("_order");
  CREATE INDEX "pages_blocks_hero_banner_links_parent_id_idx" ON "pages_blocks_hero_banner_links" USING btree ("_parent_id");
  CREATE INDEX "pages_blocks_hero_banner_links_locale_idx" ON "pages_blocks_hero_banner_links" USING btree ("_locale");
  ...
  CREATE INDEX "pages_blocks_hero_banner_locale_idx" ON "pages_blocks_hero_banner" USING btree ("_locale");
  ...
  CREATE INDEX "pages_blocks_anchor_links_items_order_idx" ON "pages_blocks_anchor_links_items" USING btree ("_order");
  CREATE INDEX "pages_blocks_anchor_links_items_parent_id_idx" ON "pages_blocks_anchor_links_items" USING btree ("_parent_id");
  CREATE INDEX "pages_blocks_anchor_links_items_locale_idx" ON "pages_blocks_anchor_links_items" USING btree ("_locale");
  CREATE INDEX "pages_blocks_anchor_links_order_idx" ON "pages_blocks_anchor_links" USING btree ("_order");
  CREATE INDEX "pages_blocks_anchor_links_parent_id_idx" ON "pages_blocks_anchor_links" USING btree ("_parent_id");
  CREATE INDEX "pages_blocks_anchor_links_path_idx" ON "pages_blocks_anchor_links" USING btree ("_path");
  CREATE INDEX "pages_blocks_anchor_links_locale_idx" ON "pages_blocks_anchor_links" USING btree ("_locale");
  ...
  CREATE INDEX "pages_blocks_text_with_image_locale_idx" ON "pages_blocks_text_with_image" USING btree ("_locale");
  CREATE INDEX "pages_blocks_text_with_image_media_idx" ON "pages_blocks_text_with_image" USING btree ("media_id");
  ...
  CREATE INDEX "pages_blocks_double_image_card1_card1_image_idx" ON "pages_blocks_double_image" USING btree ("card1_image_id");
  CREATE INDEX "pages_blocks_double_image_card2_card2_image_idx" ON "pages_blocks_double_image" USING btree ("card2_image_id");
  ...
  CREATE INDEX "_pages_v_blocks_hero_banner_links_order_idx" ON "_pages_v_blocks_hero_banner_links" USING btree ("_order");
  CREATE INDEX "_pages_v_blocks_hero_banner_links_parent_id_idx" ON "_pages_v_blocks_hero_banner_links" USING btree ("_parent_id");
  CREATE INDEX "_pages_v_blocks_hero_banner_links_locale_idx" ON "_pages_v_blocks_hero_banner_links" USING btree ("_locale");
  ...
  CREATE INDEX "_pages_v_blocks_hero_banner_locale_idx" ON "_pages_v_blocks_hero_banner" USING btree ("_locale");
  ...
  CREATE INDEX "_pages_v_blocks_anchor_links_items_order_idx" ON "_pages_v_blocks_anchor_links_items" USING btree ("_order");
  CREATE INDEX "_pages_v_blocks_anchor_links_items_parent_id_idx" ON "_pages_v_blocks_anchor_links_items" USING btree ("_parent_id");
  CREATE INDEX "_pages_v_blocks_anchor_links_items_locale_idx" ON "_pages_v_blocks_anchor_links_items" USING btree ("_locale");
  CREATE INDEX "_pages_v_blocks_anchor_links_order_idx" ON "_pages_v_blocks_anchor_links" USING btree ("_order");
  CREATE INDEX "_pages_v_blocks_anchor_links_parent_id_idx" ON "_pages_v_blocks_anchor_links" USING btree ("_parent_id");
  CREATE INDEX "_pages_v_blocks_anchor_links_path_idx" ON "_pages_v_blocks_anchor_links" USING btree ("_path");
  CREATE INDEX "_pages_v_blocks_anchor_links_locale_idx" ON "_pages_v_blocks_anchor_links" USING btree ("_locale");
  ...
  CREATE INDEX "_pages_v_blocks_text_with_image_locale_idx" ON "_pages_v_blocks_text_with_image" USING btree ("_locale");
  CREATE INDEX "_pages_v_blocks_text_with_image_media_idx" ON "_pages_v_blocks_text_with_image" USING btree ("media_id");
  ...
  CREATE INDEX "_pages_v_blocks_double_image_card1_card1_image_idx" ON "_pages_v_blocks_double_image" USING btree ("card1_image_id");
  CREATE INDEX "_pages_v_blocks_double_image_card2_card2_image_idx" ON "_pages_v_blocks_double_image" USING btree ("card2_image_id");
  ...
  CREATE INDEX "_pages_v_blocks_image_block_locale_idx" ON "_pages_v_blocks_image_block" USING btree ("_locale");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "pages_blocks_hero_banner_links" CASCADE;
  DROP TABLE "pages_blocks_hero_banner" CASCADE;
  DROP TABLE "pages_blocks_page_header" CASCADE;
  DROP TABLE "pages_blocks_anchor_links_items" CASCADE;
  DROP TABLE "pages_blocks_anchor_links" CASCADE;
  ...
  DROP TABLE "_pages_v_blocks_hero_banner_links" CASCADE;
  DROP TABLE "_pages_v_blocks_hero_banner" CASCADE;
  DROP TABLE "_pages_v_blocks_page_header" CASCADE;
  DROP TABLE "_pages_v_blocks_anchor_links_items" CASCADE;
  DROP TABLE "_pages_v_blocks_anchor_links" CASCADE;
  ...
  DROP TYPE "public"."enum_pages_blocks_hero_banner_links_link_type";
  DROP TYPE "public"."enum_pages_blocks_hero_banner_links_link_appearance";
  DROP TYPE "public"."enum_pages_blocks_hero_banner_alignment";
  DROP TYPE "public"."enum_pages_blocks_text_with_image_media_position";
  DROP TYPE "public"."enum_pages_blocks_text_with_image_link_type";
  DROP TYPE "public"."enum_pages_blocks_text_with_image_link_appearance";
  DROP TYPE "public"."enum_pages_blocks_double_image_card1_link_type";
  DROP TYPE "public"."enum_pages_blocks_double_image_card2_link_type";
  ...
  DROP TYPE "public"."enum__pages_v_blocks_hero_banner_links_link_type";
  DROP TYPE "public"."enum__pages_v_blocks_hero_banner_links_link_appearance";
  DROP TYPE "public"."enum__pages_v_blocks_hero_banner_alignment";
  DROP TYPE "public"."enum__pages_v_blocks_text_with_image_media_position";
  DROP TYPE "public"."enum__pages_v_blocks_text_with_image_link_type";
  DROP TYPE "public"."enum__pages_v_blocks_text_with_image_link_appearance";
  DROP TYPE "public"."enum__pages_v_blocks_double_image_card1_link_type";
  DROP TYPE "public"."enum__pages_v_blocks_double_image_card2_link_type";
